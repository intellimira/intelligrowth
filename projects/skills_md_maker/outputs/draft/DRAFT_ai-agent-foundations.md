...
quality_gates: [agent_defined, tools_registered, memory_configured, workflow_validated, guardrails_active, cost_budgeted]
...
1. Identify task type (simple, multi-step, or complex)
2. Determine required tools and capabilities
3. Configure memory (short-term + long-term)
4. Implement agent loop (perceive → reason → act → observe)
5. Add guardrails and human-in-the-loop checkpoints
