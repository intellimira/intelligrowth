...
You can Invoke this command in Gemini CLI with:
```
/canvas:generate "Note file name"
```

If you would like to update the following Command Prompt, you will need to updated it at the following path of your Obsidian Project:
```
.gemini/commands/canvas/generate.toml
```

If you would like to us your own Gemini API from Google:
1. Open your Obsidian path with any Coding IDE (e.g. Visual Studio Code; Cursor; etc)
2. Copy '.env.example' file, and rename the copy file as '.env' file
3. Open the '.env' file to add your API key

Of cause, you can directly login Gemini CLI with your Google account to, for details, please check the following link:
https://github.com/google-gemini/gemini-cli

# Command Prompt for Gemini
## Your Role:
